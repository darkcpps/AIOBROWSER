...
from PyQt6.QtWidgets import (QDialog, QVBoxLayout, QLabel, QWidget, QCheckBox, 
                             QFrame, QHBoxLayout, QPushButton, QFileDialog, QGraphicsDropShadowEffect,
                             QLineEdit)
...
class SettingsDialog(QDialog):
    ...
    def initUI(self):
        ...
        gen_title.setStyleSheet(f"color: {COLORS['accent_primary']}; font-size: 11px; font-weight: 900; letter-spacing: 1px;")
        ...
        down_title.setStyleSheet(f"color: {COLORS['accent_primary']}; font-size: 11px; font-weight: 900; letter-spacing: 1px;")
        ...
        path_box = QFrame()
        path_box.setStyleSheet(f"background-color: {COLORS['bg_secondary']}; border: 1px solid {COLORS['border']}; border-radius: 10px;")
        path_box_layout = QHBoxLayout(path_box)
        
        self.path_display = QLabel(self.settings_manager.get("default_download_path", "Not set"))
        self.path_display.setStyleSheet(f"border: none; color: {COLORS['text_primary']}; font-size: 12px;")
        ...
        emu_title.setStyleSheet(f"color: {COLORS['accent_primary']}; font-size: 11px; font-weight: 900; letter-spacing: 1px;")
